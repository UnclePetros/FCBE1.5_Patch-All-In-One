...
$ultima_giornata = $giornata_ultima;
	...
	tabella_squadre($vedi_squadra,"#042e7b","stateam.php?o_team");
	echo "	<div class='box_utente_header-noround2' style='border-top: 1px solid #042e7b'>STATISTICHE $vedi_squadra</div>
	<div class='box_utente_content_simple'>";
	if (@is_file($file0)) echo"<div class='box-shadow' style='margin: 5px;background-image: none;float:right'><img src='$file0' border='0' /></div>";
	if (@is_file($file1)) echo"<div class='box-shadow' style='margin: 5px;background-image: none;float:left'><img src='$file1' border='0' vspace='10' alt='Maglietta' /></div>";
	echo "<div align='center' style='font-size:16px;margin: 10px'>Dati statistici aggiornati all'ultima giornata di campionato ( ".intval($ultima_giornata)."° )</div>
	<table width='100%' cellpadding='0' cellspacing='2' align='center' bgcolor='$sfondo_tab'>
