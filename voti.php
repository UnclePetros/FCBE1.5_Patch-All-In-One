...
$tabella = "
<div class='box_utente_header-noround2' style='border-top: 1px solid #042e7b'>VOTI DELLA GIORNATA N.".intval($giornata)."</div>
<div class='box_utente_content_simple'>
<table width='100%' cellspacing='1' cellpadding='1' align='center'><tr>
<td class='testa'>Num.</td>
<td class='testa'>Nome</td>
<td class='testa'>Ruolo</td>
<td class='testa'>Voto</td>
<td class='testa'>Voto FC</td>
...
schedeRuoli_voti($ruolo_guarda,$giornata,"#042e7b","voti.php?ruolo_guarda");
echo $tabella;
