...
if(!$top11_giornata) $top11_giornata = $giornata_ultima;
	
#######################################

$vedi_squadra = $_SESSION['utente'];
echo "<div class='box_utente_header-noround2'>MAGIC TEAM GIORNATA N.$top11_giornata </div>
...
echo "<form method='post' action='./bestteam.php'>
Giornata: <select name='top11_giornata'>";
		for ($num1 = 1; $num1 < 40 ; $num1++) {
			if (strlen($num1) == 1) $num1 = "0".$num1;
