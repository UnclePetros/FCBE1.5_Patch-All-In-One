...
if ($_SESSION['valido'] == "SI") {
	...
	if ($ultima_giornata == "") 
			...
			Statistiche ancora non disponibili. E' necessario che sia stata giocata almeno una giornata di campionato.
			</span></div>";
	else {
		$vedi_squadra = $_SESSION['utente'];
		echo "
		<div class='box_utente_header-noround2'>STATISTICHE SQUADRA</div>
		<div class='box_utente_content_simple'>
		<div align='center' style='font-size:16px;margin: 10px;'>Dati statistici aggiornati all'ultima giornata di campionato ( ".intval($ultima_giornata)."° )</div>";

		$tabella = "<table width='100%' cellpadding='0' cellspacing='1' align='center' bgcolor='$sfondo_tab' summary='Tabella statistiche squadra'>
