...
if ($_SESSION['valido'] == "SI") {
	...
	if ($chiusura_giornata != 1) {
		...
		else $cerca = @file($prima_parte_pos_file_voti."00".$seconda_parte_pos_file_voti);
...
*/
							...
							if ($sec_restanti < 1 OR ($stato_mercato != "I" and $stato_mercato != "P")) {
								...
								if ($outente == $_SESSION['utente']) {
									...
									elseif ($mercato_libero == "NO") {
										...
										elseif ($stato_mercato == "P") $offri = "<td align='center'><a href='vedi_vendi_subito.php?num_calciatore=$numero' class='user'>vendi</a></td>";
					...
					if ($outente == $_SESSION['utente']) {
						...
						if ($xsquadra_ok != "SI") {
							...
							<input type='submit' name='cambia_formazione' value='Cambia la formazione' />\n
